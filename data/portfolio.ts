...
export const copy = {
  ...
  projects: {
    ...
    sourceIndex: { en: "GitHub Source", th: "GitHub Source" },
  },
  methodology: {
  ...
  contact: {
    ...
    formSuccess: {
      en: "Message sent successfully. Thank you for reaching out.",
      th: "\u0e2a\u0e48\u0e07\u0e02\u0e49\u0e2d\u0e04\u0e27\u0e32\u0e21\u0e2a\u0e33\u0e40\u0e23\u0e47\u0e08 \u0e02\u0e2d\u0e1a\u0e04\u0e38\u0e13\u0e17\u0e35\u0e48\u0e15\u0e34\u0e14\u0e15\u0e48\u0e2d\u0e04\u0e23\u0e31\u0e1a",
    },
    formErrorGeneric: {
      en: "Could not send your message. Please try again or email me directly.",
      th: "\u0e2a\u0e48\u0e07\u0e02\u0e49\u0e04\u0e27\u0e32\u0e21\u0e44\u0e21\u0e48\u0e2a\u0e33\u0e40\u0e23\u0e47\u0e08 \u0e25\u0e2d\u0e07\u0e2d\u0e35\u0e01\u0e04\u0e23\u0e31\u0e49\u0e07\u0e2b\u0e23\u0e37\u0e2d\u0e2d\u0e35\u0e40\u0e21\u0e25\u0e42\u0e14\u0e22\u0e15\u0e23\u0e07",
    },
    formEmailUnavailable: {
      en: "Gmail draft is ready. Send it from Gmail to complete the message.",
      th: "Gmail draft is ready. Send it from Gmail to complete the message.",
    },
    formEmailFallbackCta: {
      en: "Open Gmail draft",
      th: "\u0e40\u0e1b\u0e34\u0e14 Gmail draft",
    },
